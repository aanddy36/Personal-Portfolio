...
export const Hero = () => {
  ...
  return (
    <div
      className="grid relative h-[750px] place-items-center tablet:h-[880px] laptop:h-[650px]"
      ref={cardCont}
    >
      <div
        ...
        <div className="w-full flex justify-center gap-2 tablet:gap-[10%]">
          <a href="#contact">
            <button
              ...
              tablet:h-11 tablet:mt-0 laptop:text-lg laptop:px-8 laptop:h-[50px] z-[100]"
            >
